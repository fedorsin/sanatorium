...
import {Context} from '../../..';
import {deleteCity, fetchCities} from '../../../http/itemAPI';
...
const DeleteCity = ({show, onHide}) => {
    ...
    const removeCity = () => {
        deleteCity(item.selectedCity.id).then(data => {
            onHide()
    ...
    return (
        ...
        >
            ...
            <Modal.Footer>
                ...
                <Button variant="outline-danger" onClick={removeCity}>Удалить</Button>
            </Modal.Footer>
        </Modal>
    );
};
