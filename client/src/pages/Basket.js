    ...
    if(basket.basketItems.length === 0) {
        return (
            <div className="flex flex-column items-center my-52">
                ...
                <div className="mt-5"><span className='font-medium text-3xl'>В избранном пусто...</span></div>
            </div>
        )
    }
        ...
        <div className='py-20'>
            <div>
                <div className='grid grid-rows-2 justify-end mt-44 mr-10'>
                    <button className='basketOrder' onClick={() => setOrderVisable(true)}>В избранном</button>
                    <div className='flex text-xl font-medium justify-center items-center'>
                        Цена: от {basket.totalPrice} ₽
                    </div>
                </div>
